...
public class ProgressButton extends JButton {
    ...
    protected final int edgeW, edgeH;
    ...
    protected void paintFirstHalf(Graphics g){
    ...
    protected void drawButtonText(Graphics g, String t) {
        g.setFont(MCFont.getFont(t).deriveFont(16f));
